...
void init_files()
{
global.moviefile = fopen("../../tabulated.mvi","wb");
...
{
global.step =0.1;
global.index_factor = 10;
global.max_dist = 16.0;
global.r2array_size = 0;
global.r2Array = (double *) malloc(global.index_factor * global.max_dist * sizeof(double));

double r2,f,r;

double step = 0.0;

while(step < global.max_dist)
        {
        r2 = step;
        ...
        global.r2Array[global.r2array_size++] = (double)f/r;
        step += global.step;
    }
}
